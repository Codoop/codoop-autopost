#!/bin/sh
# Run bundled Python with the version required by last30days v3.
set -eu
...
echo "codoop-autopost requires Python 3.12+. On macOS: brew install python@3.12; or set CODOOP_AUTOPOST_PYTHON to its executable." >&2
exit 1
