...
The first command downloads the MIT-licensed upstream runtime to the user's data directory. The second prints machine-readable research. Score candidates for relevance, recency, engagement, and availability of primary evidence. Hand off every surviving claim to `codoop-firecrawl` for verification.
